...
plot \
	"Insert-sort-rond.dat" title "Randomicos" w linespoints,\
        "Insert-sort-ord.dat" title "Ordenados" w linespoints, \
        "Insert-sort-inv.dat" title "Invertidos" w linespoints
